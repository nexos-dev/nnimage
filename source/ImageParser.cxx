...
// error" on configuration file error. This may be harder to maintain, but I much prefer using a
// hand-rolled parser and being in control NOTE2: I might end up making the lexer use re2c or
// something but that's a future me problem
